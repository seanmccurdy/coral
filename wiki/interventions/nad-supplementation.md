---
type: intervention
title: NAD supplementation and infusion
...
```mermaid
flowchart LR
  NR[NR or NMN] --> M[Salvage metabolism]
  IV[IV NAD] --> N[NAD pool / metabolites]
  M --> N
  N --> C[Redox and NAD-consuming enzymes]
  C -. uncertain .-> H[Healthspan]
  IV --> A[Acute infusion reactions]
```
